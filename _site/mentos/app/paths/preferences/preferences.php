			...
			<form method="post" action="<?php echo $Mint->cfg['installDir'];?>/">
				...
				<div class="general-column">
					...
					<table>
						...
						<tr>
							<td></td>
							<td><label><input type="checkbox" id="ignore_mint_2" name="ignore_mint_2" value="1"<?php echo ($Mint->cfg['preferences']['ignoreMint2'])?' checked="checked"':''?> /> Ignore available <a href="http://www.haveamint.com/">Mint 2</a> updates</label></td>
						</tr>
					</table>
